...
class _SeccionAuditoriaState extends State<SeccionAuditoria> {
  ...
  static String _etiqueta(TipoEventoAuditoria t) => switch (t) {
        ...
        TipoEventoAuditoria.verificacionLector => 'Verificaciones de lector',
        TipoEventoAuditoria.altaUsuarioInterno => 'Altas de personal',
        TipoEventoAuditoria.bajaUsuarioInterno => 'Bajas de personal',
  ...
  static IconData _icono(TipoEventoAuditoria t) => switch (t) {
        ...
        TipoEventoAuditoria.verificacionLector => Icons.verified_user_outlined,
        TipoEventoAuditoria.altaUsuarioInterno => Icons.badge_outlined,
        TipoEventoAuditoria.bajaUsuarioInterno => Icons.no_accounts_outlined,
